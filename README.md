...
![Typing SVG](https://readme-typing-svg.herokuapp.com?font=Fira+Code&size=23&pause=1100&color=00F7FF&center=true&vCenter=true&width=900&lines=Python+Developer;Full-Stack+Engineer+(React+%2F+Node);AI+%2F+ML+Developer;Clean+Code+Advocate;18%2B+Projects;Building+Scalable+Systems)
...
YOLO • Scikit-Learn • TensorFlow • OpenCV • EDA • Data Analysis
...
Real-time analytics using AI vision:
...
## 💼 **Personal Portfolio**
Beautiful, animated, minimal & modern UI.  
...
- Build SaaS tools using Python + React  
- Contribute to open-source Python & ML  
